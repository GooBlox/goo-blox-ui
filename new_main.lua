...
function UI:Notify(text, duration, kind)
	...
	if isLight then
		...
		kinds = {
			...
			success = {
				bg = Color3.fromRGB(220, 245, 210),
				bar = Color3.fromRGB(60, 145, 40),
				tc = Color3.fromRGB(30, 100, 20),
			},
			warn = {
				bg = Color3.fromRGB(255, 240, 205),
				bar = Color3.fromRGB(185, 120, 20),
				tc = Color3.fromRGB(120, 75, 10),
			},
			error = {
				bg = Color3.fromRGB(255, 220, 218),
				bar = Color3.fromRGB(210, 60, 55),
				tc = Color3.fromRGB(150, 30, 25),
			},
		}
	else
